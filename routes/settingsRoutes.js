...
const { uploadSongCover } = require('../controllers/artistController')
const { upload, uploadToCloudinaryAvatar, uploadToCloudinarySongCover } = require('../middleware/uploadMiddleware');
